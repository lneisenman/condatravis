...
project = u'condatravis'
copyright = u'2015, Larry Eisenman'
...
htmlhelp_basename = 'condatravis-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'condatravis Documentation',
   u'Larry Eisenman', 'manual'),
]
